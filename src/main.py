...
from src.transformations.bpmn_parser import parse_bpmn_to_reduced_graph, Node, ReducedEdge
from src.transformations.path_extractor import enumerate_paths_and_build_ir
from src.exporters.ddl_exporter import rule_ir_to_ddl

from src.exporters.swrl_exporter import export_rules_to_owl
from src.exporters.legalruleml_exporter import export_rules_to_legalruleml
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    export_rules_to_owl(
        rules_ir,
        out_file="outputs/rules_swrl.owl",
    ...
    export_rules_to_legalruleml(
        rules_ir,
        superiority,
        out_file="outputs/rules_legalruleml.xml",
    )
