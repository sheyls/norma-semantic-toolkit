...
Usage
-----
python -m norma_engine.cli.rules regulations/eu-ai-act/bpmn/art50-art95.bpmn
python -m norma_engine.cli.rules path/to/file.bpmn outputs/my_rules.txt
"""
...
from norma_engine.parsing.bpmn_parser import parse_bpmn_to_reduced_graph, Node, ReducedEdge
